...
# Security settings
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-some-very-secret-and-long-key-for-saas')
...
if db_name:
    DATABASES = {
        'default': {
            ...
            'NAME': db_name,
            'USER': os.getenv('POSTGRES_USER', 'gotlr_user'),
            'PASSWORD': os.getenv('POSTGRES_PASSWORD', 'gotlr_password'),
...
# SimpleJWT settings
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=1), # Extended for easy development
